...
class Controller
{
    ...
    protected function registerArchiveAssets(\WP_Screen $screen)
    {
        ...
        if (Helper::endsWith('_archive', $screen->id) && 'edit.php' == $screen->pagenow) {
    ...
    protected function registerCodemirrorAssets(\WP_Screen $screen)
    {
        ...
        if ('settings_page_pollux' !== $screen->id || 'options-general.php' !== $screen->pagenow) {
            return;
        }
    ...
    protected function registerGateKeeperAssets(\WP_Screen $screen)
    {
        ...
        if ('settings_page_pollux' == $screen->id
            && 'options-general.php' == $screen->pagenow
